...
import { Card, Col, Container, Row, Form, Button, FormGroup } from "react-bootstrap";
...
export default function Permits() {
  ...
  <Form.Group className="mb-3" controlId="formBasicEmail">
                  ...
                  <Form.Control type="text" placeholder="Place name" onChange={(e) => setPlace(e.target.value)} />
                </Form.Group>{" "}
                <Form.Group className="mb-3" controlId="formBasicEmail">
                  <Form.Label> Number of expected Visitors </Form.Label>{" "}
                  <Form.Control
                    type="text"
                    placeholder="Number of expected Visitors" onChange={(e) => setNumberOfPeople(e.target.value)}
                  />
                </Form.Group>{" "}
              <FormGroup>
              <Button
